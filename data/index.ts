...
export const projects = [
  ...
  {
    id: 4,
    title: "Sneat Financial Dashboard",
    des: "Recreated the sneat dashboard that gives you an overview of your financial reports",
    img: "/sneatt.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/three.svg", "/gsap.svg"],
    url: "https://assessment-dashboard-one.vercel.app/login",
  },
];
...
export const workExperience = [
  {
    id: 1,
    title: "Junior Front-end engineer at DrdoGood",
    desc: "Assisted in the development of a web-based platform using Next.js and other technologies, enhancing interactivity.",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
  {
    id: 2,
    title: "Front-end engineer intern at AyaData-Leading AI company in Ghana",
    desc: "Worked closely with the backend engineers to develop a well seamless experience for users.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
];
